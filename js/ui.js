...
function _renderSkeletonDashboard(){
  // Bo'sh — skeleton ataylab olib tashlangan.
  // Dashboard'ning statik HTML'ini buzmaslik uchun hech narsa chizilmaydi.
}
...
function _renderDesignerChat(el){
  ...
  el.innerHTML=`<div class="chat-layout chat-layout-single">
    <div class="chat-main" id="chat-main-panel">${_renderChatArea(myDid)}</div>
  </div>`;
  _scrollChatBottom();
}
